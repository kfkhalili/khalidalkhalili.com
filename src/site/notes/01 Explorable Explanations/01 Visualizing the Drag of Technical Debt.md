...
Just like this simulator, technical debt accumulates whether you like it or not. The only influence you have is how much time you set for deal with it, but it'll cost you. More time to fix bugs and refactor code means you have less time to ship features, so you'll need some kind of strategy.
