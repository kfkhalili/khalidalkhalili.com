...
export default async function TechnicalDebtPage({
  ...
  return (
    <article className="mx-auto max-w-3xl px-5 py-16 sm:py-20">
      ...
      {/* This explorable is English content — pin it LTR regardless of UI locale. */}
      <div lang="en" dir="ltr">
        ...
        <div className="prose mt-10">
          ...
          <p>
            ...
            , John Ousterhout defines complexity as &ldquo;anything related to
            the structure of a software system that makes it hard to understand
            and modify&rdquo;. This interactive model visualizes that friction.
            It explores the tension between{" "}
            <strong>Tactical Programming</strong> (shipping fast now) and{" "}
            <strong>Strategic Programming</strong> (investing in design for the
            future).
          </p>

          <p>
            Complexity accumulates whether we like it or not. The only influence
            we have is how much time we set for dealing with it. More time to
            fix bugs and refactor code means you have less time to ship
            features, so you&rsquo;ll need some kind of strategy.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Full Refactor (80%):</strong> The emergency brake. You
              stop shipping to clean up the mess. It works, but it&rsquo;s a
          ...
          <p>
            This simulation isn&rsquo;t random. It is driven by the battle
            between two opposing forces: <strong>Entropy</strong> and{" "}
          ...
          <ol>
            <li>
              ...
              naturally tends toward disorder as features are added, and if you
              do nothing, debt grows &mdash; and the more it grows, the more it
              compounds.
            </li>
            <li>
          ...
          <details>
            ...
            <p>
              ...
              from the future. The &ldquo;missing&rdquo; 30% velocity in a
              healthy team isn&rsquo;t waste; it is the{" "}
              <strong>Cost of Doing Business</strong>. Communication, design,
              and maintenance are hard work.
            </p>
          </details>
          ...
          <details>
            ...
            <p>
              ...
              &mdash; the necessary friction of writing tests, documentation,
              and code reviews. &ldquo;Perfectly happy&rdquo; usually implies
          ...
          <details>
            ...
            <p>
              ...
              <strong>Break-Even Point</strong> for refactoring becomes
              impossibly high.
            </p>
          </details>
          ...
          <details>
            ...
            <p>
              ...
              shipping. A strategy of 100% refactoring (Gold Plating) kills
              morale just as fast as 0% refactoring (Spaghetti Code). Engineers
              need to feel the momentum of delivery to stay engaged.
            </p>
          </details>
          ...
          <details>
            ...
            <p>
              ...
              <strong>cost of recovery</strong> becomes unpayable. At
              saturation, the required &ldquo;Full Refactor&rdquo; means
              shipping nothing for months. This is{" "}
              <strong>Economic Bankruptcy</strong>.
            </p>
          </details>
          ...
          <details>
            ...
            <p>
              <strong>70% Velocity</strong> (with its associated maintenance
              cost) is better than <strong>40% Velocity</strong> (perfect code).
              If you have 0% debt but are moving slowly because you are polishing
              code, you are failing just as badly as the team with high debt.
              The goal is the <em>sustainable maximum</em>.
            </p>
          </details>
