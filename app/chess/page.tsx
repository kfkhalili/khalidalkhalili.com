  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 sm:py-20">
      <header>
        ...
        <p className="mt-3 max-w-xl text-muted">{strings.chess.subtitle}</p>
        <div className="mt-5 flex flex-wrap items-center gap-2">
          <a
            href={CHESS_PROFILE_URL}
            target="_blank"
            rel="noopener noreferrer"
            aria-label={strings.chess.viewProfile}
            title={strings.chess.viewProfile}
