...
const ar: ThirdThingContent = {
  ...
  thirdThing: `طبعًا يبدو الأمر معقولًا على الورق. يحتفظ المورّد بملكيته الفكرية، كشركة منتَجات. لكنه يشغّل أيضًا ما يبنيه، على حساباتك السحابية، كشركة خدمات. تذاكره تعيش في Jira خاصّته التي لا تستطيع الاطلاع عليها. شيفرته صندوقٌ أسود. خوادمه تُضخّم فاتورتك، ولا يحقّ لك حتى تحديد حجمها. الملكية والتشغيل والرؤية: ثلاثتها تشير الآن إلى جهاتٍ مختلفة، ولا واحدة منها تشير إليك.`,
  symptoms: [
  ...
  dialect: [
    ...
    `ما يجعل محاربة هذه اللهجة شبه مستحيلة أنها ليست الوثيقة كلها ولا شخصًا واحدًا بعينه. صفحات الحالة الحقيقية تحمل جملًا صادقةً محسوبةً بدقة إلى جوار الجمل المتحوّطة، فلا تستطيع الاعتراض على الصفحة، بل على شذراتٍ منها فقط، والاعتراض على الشذرات يبدو تنطّعًا. ثم إن اللهجة جوقةٌ لا صوتٌ منفردٌ. «الأمر يعتمد». «علينا أن ندرس الأمر». «لا أستطيع أن أجيبك». حين تقول أفواهٌ كافية هذه الأشياء، تكفّ اللهجة عن كونها طبعَ شخصٍ وتصبح اللغةَ الأمَّ للغرفة، الشيء الذي يتشرّبه القادمون الجدد بوصفه جزءًا من التأهيل.`,
    `وتُكمل الأقدمية الحيلة، لا لأن المخضرم يخادع. فحين يقول من أمضى عقودًا في النظام «الأمر يعتمد»، فالأمر غالبًا يعتمد فعلًا. لقد شاهد إجاباتٍ واثقة تنهار من قبل. المشكلة أن الغرفة لا تستطيع التمييز بين الحذر المكتسَب والمراوغة، وكلاهما يخرج بالكلمات نفسها. فيستعير كلُّ تحوّطٍ فارغ في الجوقة مصداقيةَ المخضرم، ويُسمَع الغموض، إذا قيل من مقامٍ عالٍ بما يكفي، حكمةً.`,
  ],
