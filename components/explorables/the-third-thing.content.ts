...
const de: ThirdThingContent = {
  ...
  dialect: [
    ...
    `Erfahrung vollendet den Trick, und zwar nicht, weil der Veteran blufft. Wenn jemand „kommt darauf an“ sagt, der das System seit zwanzig Jahren kennt, kommt es meistens wirklich darauf an. Solche Leute haben schon zu viele vollmundige Antworten zusammenbrechen sehen. Das Problem ist, dass niemand im Raum verdiente Vorsicht von Ausweichen unterscheiden kann, und beides kommt als dieselben drei Wörter heraus. Also darf sich jede leere Floskel im Chor die Glaubwürdigkeit des Veteranen leihen, und Unverbindlichkeit, von weit genug oben gesprochen, wird als Weisheit gehört.`,
  ],
  ...
  diagnostic: {
    ...
    questions: [
      ...
      { q: `Wer kann die Arbeit sehen?`, options: [`Wir können es`, `Wir können es nicht`] },
    ],
    verdictLabel: `Urteil`,
    verdicts: {
      product: `Eine saubere Produktform. Es gehört ihnen, du betreibst es. Deren Roadmap ist Wetter, keine Abhängigkeit, und du behältst das Recht zu gehen.`,
