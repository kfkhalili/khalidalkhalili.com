...
const de: ThirdThingContent = {
  ...
  diagnostic: {
    ...
    verdicts: {
      ...
      hosted: `Ein gehostetes Produkt. Immer noch die Produktform, nur von ihrer Seite des Zauns betrieben: Ihnen gehört es, sie betreiben es, sie bezahlen es, und du kaufst das Ergebnis. Völlig in Ordnung, solange die Schnittstellen klar sind und du das Recht behältst zu gehen.`,
...
const ar: ThirdThingContent = {
  ...
  opening: [
    `على حدّ علمي، هناك بالضبط طريقتان صريحتان لشراء البرامج من شركةٍ أخرى.`,
    ...
    `أو تشتري خدمة. يعملون في قائمة مهامك، وعلى بنيتك التحتية، ووفق أولوياتك، وكل ما يبنونه ملكٌ لك. يتقاضون أجرهم عن كل مهمةٍ مُسلَّمة. وإن لم يعد الأمر مجديًا، استبدلتهم واحتفظت بمصدر البرنامج، ببساطة.`,
    `لا تفتقر تقنية المعلومات في الشركات إلى الكوارث. لكنَّ نوعًا واحدًا يبدأ دائمًا بالطريقة نفسها: شخصٌ ما يوقّع عقدًا على <strong>شيءٍ ثالث</strong>. وقد شهدت هذا عدة مراتٍ حتى الآن.`,
  ],
  thirdThing: `طبعًا يبدو الأمر منطقيًا على الورق. يحتفظ المورّد بملكيته الفكرية، كشركة منتَجات. لكنه يشغّل أيضًا ما يبنيه، على حساباتك السحابية، كشركة خدمات. قائمة مهامه خاصّة ولا تستطيع الاطلاع عليها. مصدر البرنامج صندوقٌ أسود. خوادمه تُضخّم فاتورتك، ولا يحقّ لك حتى تحديد حجمها. الملكية والتشغيل والرؤية: ثلاثتها تشير الآن إلى جهاتٍ مختلفة، ولا واحدة منها تشير إليك.`,
  symptoms: [
    `ما يلي مزيجٌ من كل الحالات التي شهدتها. يأتي الجدول أولًا. يحتاج أحدهم إلى تتبّع تقدّم المورّد، وقائمة مهام المورّد غير متوفرة. فيظهر جدول بيانات يُحدَّث يدويًا: عشرات الأعمدة، بعضها نسخة طبق الأصل عن الأخرى، وكل صفٍّ ظلٌّ لمهمةٍ تعيش أصلًا في مكانٍ لا تستطيع رؤيته. قد تضحك من الجدول، لكن لا تفعل. فالجدول نسيجُ ندبة، وكل جدول ظلٍّ في فريقك يشير إلى موضعٍ يُئس فيه من أداةٍ مشتركة فنبت حلٌّ التفافيٌّ مكانها.`,
    `ثم ينعقد اجتماعٌ آخر، وينفتح بابٌ آخر. تقدّم المورّد لا يُرى، فتظهر مكالمة «تنسيقية» يومية كي يُسأل المورّد كيف تسير الأمور. يُدعى إليها عشرات الأفراد. منهم من يعتذر عن الحضور. ومعظمهم لا يردّ أصلًا، لأن الاعتذار والقبول كلاهما التزام، وأسلم جوابٍ أحيانًا هو لا جواب. يحضر فعليًا نحو اثني عشر شخصًا، كل صباح، لنصف ساعة. تبدو الدعوة مفيدةً في شكلها، لكنها استطلاعُ حالةٍ متنكّر. إذا غُيِّبت الأنظمة، أُجبر الأفراد على سد الفراغ، وهذه الآلية تعمل على حساب كشف الرواتب. اثنا عشر شخصًا، نصف ساعة، خمسة أيام في الأسبوع، إلى الأبد. وكل ذلك ثمن غياب نظام مهامّ مشترك.`,
    `ثم الصفحات، وحدِّث عنها ولا حرج. ينشئ أحدهم صفحة لتوثيق موضوعٍ سينتهي في قائمة مهام أحدهم في كل حال. بعد أشهر تزدحم الصفحة، وتنظيفها عملٌ إضافي، فيُودِعها الأرشيف ويستنسخ نسخةً جديدة. لا بأس. غير أن الرابط في دعوة الاجتماع الدوري ما يزال يشير إلى الصفحة القديمة، وسيبقى كذلك سنوات، فمن يعدّل سلسلة اجتماعاتٍ أصلًا؟ وليس في الأمر خبث، حقيقةً، وهذا هو الشيء المزعج. كل خطوةٍ كانت تسهيلًا صغيرًا مستقلًّا تمامًا عن غيره.`,
  ...
  dialectIntro: `وفوق كل شيءٍ تستقرّ طريقةٌ في الكلام. «في أقرب وقتٍ ممكن». «حيثما كان ذلك منطقيًا». «بأعلى أولوية». «سنحتاج إلى دراسة الأمر». أصغِ إلى هذه الجمل كما يصغي المهندس: لا يمكن لأيٍّ منها أن تكون خاطئةً أبدًا. وهذا يبدو مديحًا حتى تفكر به قليلًا. فالجملة التي لا يمكن أن تكون خاطئة لا تحمل معلومة؛ إنها لا تستبعد شيئًا. إن أُكثر منها يصبح تقريرُ الحالة متوافقًا مع كل واقعٍ ممكن، وهذا ما يحتاجه المستمعون. عرّف الفيلسوف <a href="${FRANKFURT}" target="_blank" rel="noopener noreferrer">هاري فرانكفورت</a> <a href="${ON_BULLSHIT}" target="_blank" rel="noopener noreferrer">الهراء</a> بأنه كلامٌ لا يبالي بالحقيقة. وقد كتب في ذلك كتابًا كاملًا. وكان يكفيه أن يقرأ صفحة حالة مشروعٍ واحدة ليوفّر على نفسه العناء.`,
  dialect: [
    `في هذه اللهجة العمل دائمًا في المستقبل، وقد أخذ مني وقتًا حتى انتبهت إلى ذلك. «سننظر في الأمر الأسبوع المقبل» تصير «نظرنا في الأمر، وسنعالجه الشهر المقبل». النظر في الأمر يُنتج نظرًا آخر في الأمر؛ الأفق يتدحرج، ووحدة زمن الانتظار تتضخّم، فيصير الأسبوع شهرًا. وللتصعيد بابه الخاص: تصعيدٌ لا يسلّم شيئًا سوى أنه حدث، بلا تاريخٍ مرفق ولا أثرٍ مسمّى. وحين تتحوّل شارة الحالة أخيرًا من الأصفر إلى الأحمر، اقرأ الصفحة تحتها: الجمل هي نفسها. يتغيّر اللون ولا تتغيّر اللهجة. فالأحمر ليس إلا أصفر مع تهديدٍ بالعنف.`,
    ...
    `ويُكمل المخضرمون الحيلة، ليس لأن المخضرم يخادع. فحين يقول من أمضى عقودًا في النظام «الأمر يعتمد»، فالأمر غالبًا يعتمد فعلًا. لقد رأى إجاباتٍ واثقة تنهار من قبل. المشكلة أن الغرفة لا تميّز الحذر المكتسَب من المراوغة، وكلاهما يخرج بالكلمات نفسها. فيستعير كلُّ مبهم من المجموعة مصداقيةَ المخضرم، ويُرى الغموض، إذا قيل من مقامٍ عالٍ بما يكفي، كنوعٍ من الحكمة.`,
  ],
  composite: `إن كان هذا يشبه مشروعك: أعدك أنني لم أكن أصف مشروعك. وهذا أشدّ ما يمكنني قوله إدانةً. إنه يشبه المشاريع كلَّها.`,
  why: [
    `لماذا يتقدم المرض؟ إليك مشهدًا واحدًا، مركّبًا مثل غيره. يُعطى المورّد سؤالًا لا يجيب عنه إلا فريق تقني للبنية التحتية. تحليل تكلفة، أو خطة سعة، اختر ما شئت. والسبب أن خوادمه لم تُستخدم بكفاءة على حساب العميل. المورّد في هذا المشهد غرفةٌ من علماء مختصين. بارعون فيما استُقدموا له. ليسوا مؤهّلين للعمل التقني للبنية التحتية. كلُّ حاضر يعرف الأمرين، بمن فيهم المدير، الذي يقول الآن الجملة التي يقولها المديرون في هذا الموقف دائمًا. وتأتي في ثلاثة أجزاء: هذه مسؤوليتكم، ولا يخصني كيف ستنجزون الأمر، وإن لم يحدث الأمر فالتكاليف عليكم.`,
    ...
    `لاحظ ما يساويه التهديد فعلًا. إسنادُ المسؤولية إلى من لا يملك القدرة ليس إلا لومًا أُقرّ به مسبقًا. فالطرف الذي يحدّد حجم الخوادم لا يدفع ثمنها، والخمول هو النتيجة. وحين يكون المال قد رُصد قبل العمل بسنوات، يصير التهديد بالتكاليف تمثيليةً فوق تمثيلية: فذاك المال أُنفق أصلًا. الجميع في الغرفة يعرفون هذا كله. وتُقال الجملة رغم ذلك. فقولها هو النقلة الوحيدة المتبقية على الرقعة.`,
    `وما نتيجة ذلك الضغط؟ ليست الجواب، فهم عاجزون عن إنتاجه. ما يخرج بدلًا منه هو لغة: «سننظر في الأمر الأسبوع المقبل». اللوم يتدفق نزولًا، والمبهمات تتدفق صعودًا، ويغادر الطرفان وبيد كلٍّ منهما أثرٌ ورقي يثبت أنه أدّى دوره. لومٌ يدخل، هراءٌ يخرج. وليست اللهجة إلا طريقة الناس في تدبّر أمورهم داخل نموذجٍ مكسور.`,
  ],
  build: `غريزة المهندس عند هذه النقطة تدعوه ليبني شيئًا. شعرتُ بها بنفسي، ورأيتها عند غيري: أمام قائمة مهام مورّدٍ لا تراها، يميل المرء بمحض الغريزة إلى رسم أداةٍ لنسخ المهام بين النظامين. إنها فكرةٌ غبية، وقد يلزمك نحو أسبوعٍ من التفكير الجاد لترى السبب. الحدّ الفاصل لا يختفي. سيكون على أحدهم أن يقرّر، إلى الأبد، أيُّ المهام تُنسخ. والأداة برنامجٌ إضافي يحتاج إلى صيانة. وبعد كل ذلك الجهد، تكون قد اشتريت رؤيةً كاملة لمهامّ ما زلت عاجزًا عن التصرف فيها. سترى كل شيء ولن تغيّر شيئًا. لا تستطيع بالأدوات أن تخرج من مشكلةٍ أصلُها عقد؛ وكل نسخةٍ جديدة من الحقيقة، مهما بلغت براعتها، تنضمّ إلى الحشد الذي يغلبها بالعدد. لا شيء في مشروعٍ «لا يضرّ». <strong>كل ما لا يساعد يصبح مصدرًا للتخريب.</strong>`,
  fix: [
    `يسكن الإصلاح حيث يسكن العطب، في النموذج. إن كان المورّد يؤدي وظيفتين، فافصلهما إلى علاقتين. الأشخاص أنفسهم إن شئت؛ الشكلان مختلفان. يصبح النصف الأول شركةَ منتَجٍ حقيقية. يحتفظون بمصدر برنامجهم وخارطة طريقهم، ينشرون التحديثات كل ربع سنةٍ أو كل سنة، يتتبّعون عيوبهم بأنفسهم، ويدينون لك بواجهاتٍ واضحة بدلًا من الشفافية. تثبّت صندوقهم الأسود على بنيتك التحتية، وتشغّله أنت، وتبني حوله ما يلزمك من وصلات، وتحتفظ بحق الرحيل. ويصبح النصف الآخر فريقَ خدمةٍ حقيقيًا. يعملون في نظام مهامك، وعلى أنظمتك، ونيابةً عنك. ما يبنونه ملكٌ لك، ويتقاضون عن كل مهمةٍ مُسلَّمة، وهم قابلون للاستبدال بحكم الاتفاق نفسه. تخسر شيئًا في هذا الفصل: نصف المنتَج لن يعطيك أبدًا سوى خارطة طريق، لا موعدًا. لكن انظر إلى ما تستعيده. نصف الخدمة يعمل الآن حيث تراه، فتعرف بالضبط متى يبلغ شيءٌ ما بيئة الإنتاج، ومفتاح تشغيل البرنامج في عالمك صار أخيرًا في يدك.`,
    `نصفا هذا الحل موجودان فعلًا. تنشر إيه دبليو إس ومايكروسوفت خرائط طريقٍ لمئات الآلاف من العملاء، وتلك الخرائط لا تلتزم تقريبًا بأي شيء. ولا يغرق أحد، لأن معمارية العميل لا تعتمد على تلك الوعود؛ يبقى الغموض على الجهة الأخرى من الواجهة، حيث هو مجرّد نشرة أحوال جوية مستقبلية. إن انتقل الغموض نفسه إلى داخل قائمة مهامك، فإذا بموعد إطلاقك يعتمد فجأةً على «سننظر في الأمر». هذا هو القانون المختبئ تحت هذا المقال كله: <strong>قدرة تحمُّل العميل الهراء تعتمد على شدّة الارتباط.</strong> وهذا يشير أيضًا إلى الإصلاح الحقيقي. مطالبةُ الأفراد المضغوطين بجملٍ تحتاج الشجاعة لا تُصلح شيئًا. أصلح النموذج، حتى تعود الجمل الصريحة في المتناول من جديد.`,
  ],
  ...
  closing: [
    `لن أدّعي أن شيئًا من هذا سهل الإصلاح في مشروعٍ قائم. فعقودُ الشيء الثالث تُوقَّع لسنوات، ورؤية المشكلة بوضوح لا تضمن أنك في موقعٍ يسمح لك بقولها بصوتٍ عال. لكن المتانة سلاحٌ ذو حدّين. النموذج المكسور يدوم لأنه يُعمّر أطول ممن يحاربونه. والنموذج المُصلَح يدوم بالطريقة نفسها تمامًا. أصلح الشكل مرةً واحدة، وسيبقى الإصلاح يعمل طويلًا بعد أن يغادر كلُّ المعنيين إلى مشاريع أخرى. يكفي أن تُسمَع مرةً واحدة. والفرص لكي تُسمَع لا تنقطع: كل تجديدٍ للعقد، وكل تمديد، وكل أزمةٍ يُطلق فيها تهديدٌ لأن لا شيء آخر بقي، كلُّ واحدةٍ منها فرصةٌ جديدة للتغيير.`,
  ...
  statusPage: {
    ...
    sentences: [
      ...
      [
        `جرى الترحيل يوم الثلاثاء: أُنجزت 12 من أصل 14 خدمة، والخدمتان الأخيرتان تلحقان في السبرنت المقبل.`,
  ...
  diagnostic: {
    ...
    verdictLabel: `الحكم`,
    verdicts: {
      product: `شكل منتَجٍ صريح. هم يملكونه وأنت تشغّله. خارطة طريقهم مجرد نشرة أحوالٍ جوية، لا شيء في خطتك يعتمد عليها، وتحتفظ أنت بحق الرحيل.`,
