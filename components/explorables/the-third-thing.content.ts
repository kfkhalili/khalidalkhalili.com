...
const en: ThirdThingContent = {
  ...
  sim: {
    ...
    badges: { green: `ON TRACK`, yellow: `CAUTION`, red: `HIGH RISK` },
    sprint: `Sprint`,
    running: `● running`,
    paused: `❚❚ paused`,
    log: {
...
const de: ThirdThingContent = {
  ...
  sim: {
    ...
    badges: { green: `AUF KURS`, yellow: `GEFÄHRDET`, red: `HOHES RISIKO` },
    sprint: `Sprint`,
    running: `● läuft`,
    paused: `❚❚ pausiert`,
    log: {
...
const ar: ThirdThingContent = {
  ...
  sim: {
    ...
    badges: { green: `على المسار`, yellow: `تحذير`, red: `خطر مرتفع` },
    sprint: `الدورة`,
    running: `● يعمل`,
    paused: `❚❚ متوقّف`,
    log: {
